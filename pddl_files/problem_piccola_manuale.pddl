(define (problem dublin-piccola)
  ...
  (:init
    ...
    ; Valori realistici da SUMO/SCATS: incrocio arterioso a 2 fasi su ciclo
    ; 120s -> attesa media ~17.1s (prima erano 30s fissi)
    (= (signal-delay liffey_st_upper)     0)
    (= (signal-delay wellington_quay_e) 17.1)
